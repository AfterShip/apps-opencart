      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="module_da_track_shipment_after_ship_key" value="<?php echo $module_da_track_shipment_after_ship_key; ?>" id="input-name" class="form-control" />
              <?php if ($error_key) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="module_da_track_shipment_after_ship_username" value="<?php echo $module_da_track_shipment_after_ship_username; ?>" id="input-width" class="form-control" />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="module_da_track_shipment_status" id="input-status" class="form-control">
                <?php if ($module_da_track_shipment_status) { ?>
