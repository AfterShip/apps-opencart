...
class ControllerExtensionModuleDaTrackShipment extends Controller
{
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/da_track_shipment', 'token=' . $this->session->data['token'], true),
            'separator' => ' :: '
        );
        $data['action'] = $this->url->link('extension/module/da_track_shipment', 'token=' . $this->session->data['token'], true);
...
//        return !$this->error;
    ...
    public function uninstall() {
        ...
        $this->db->query($sql);
        $this->load->model('setting/setting');
        $this->model_setting_setting->deleteSetting('module_da_track_shipment');
    }
